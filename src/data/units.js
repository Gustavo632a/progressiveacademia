...
export const units = [
  { id: 'mandacaru', zone: 'Zona Norte', name: 'Mandacaru', city: 'João Pessoa/PB', status: 'Em funcionamento', soon: false, address: null, mapsUrl, image: '/images/estrutura-01.webp' },
